...
const LoginWindow: React.FC<Props> = ({ close, open, error, isInvalidInput, isLoading, username, password,userKeyUp, userChange, passKeyUp, passChange, login }) => {
    return (
        <>
            <div className="login-window-container">
                ...
                <input id="password" type="password" value={password} onKeyUp={passKeyUp} onChange={passChange} name="pass" placeholder="Password" required/>
